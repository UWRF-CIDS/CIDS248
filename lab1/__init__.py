...
def contains_ls():
    ...
    output = check50.run("grep -c -w 'ls' typescript").stdout().rstrip()
    if output == "0":
...
def contains_lsa():
    ...
    output = check50.run("grep -c -w 'ls -a' typescript").stdout().rstrip()
    if output == "0":
        help = "Make sure that you have tried all commands in the lab. To start the script command so that it appends to you typescript file, use 'script -a typescript'"
        raise check50.Failure(help)
...
def contains_mkdir():
    ...
    output = check50.run("grep -c -w 'mkdir' typescript").stdout().rstrip()
    if output == "0":
        help = "Make sure that you have tried all commands in the lab. To start the script command so that it appends to you typescript file, use 'script -a typescript'"
        raise check50.Failure(help)
...
def contains_cd():
    ...
    output = check50.run("grep -c -w 'cd' typescript").stdout().rstrip()
    if output == "0":
        help = "Make sure that you have tried all commands in the lab. To start the script command so that it appends to you typescript file, use 'script -a typescript'"
        raise check50.Failure(help)
...
def contains_pwd():
    ...
    output = check50.run("grep -c -w 'pwd' typescript").stdout().rstrip()
    if output == "0":
        help = "Make sure that you have tried all commands in the lab. To start the script command so that it appends to you typescript file, use 'script -a typescript'"
        raise check50.Failure(help)
